...
import ru.otus.java.pro.result.project.hotels.validators.UsernameValid;
...
public class UserDtoRq {
    ...
    @Schema(description = "Пароль доступа. Присваивается username, если отсутствует email", format = "password", requiredMode = Schema.RequiredMode.REQUIRED, minLength = 8, example = "Pass1234")
